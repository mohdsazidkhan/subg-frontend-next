      ...
      <ul className="list-disc pl-6 space-y-2">
        ...
        <li>To process rewards, including the <strong>Monthly Rewards System</strong>:
          <ul className="list-disc pl-6 mt-1 space-y-1">
            <li><strong>Monthly:</strong> Top 10 eligible users at Level 10 with {process.env.NEXT_PUBLIC_MONTHLY_REWARD_QUIZ_REQUIREMENT || 220} high-score quizzes win from ₹{process.env.NEXT_PUBLIC_MONTHLY_REWARD_PRIZE_POOL || 10000} total pool</li>
